...
import ar.org.fsadosky.iptablesmanager.adapter.ItemsAdapter;
import ar.org.fsadosky.iptablesmanager.model.ApplicationItem;
import ar.org.fsadosky.iptablesmanager.model.ApplicationsStatus;
...
public class ApplicationsListFragment extends AbstractFragment<ApplicationsListFragment.Callbacks> implements View.OnClickListener, SearchView.OnQueryTextListener {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_apply) {
            ...
            Snackbar.make(getActivity().findViewById(android.R.id.content), "Reboot device to update changes", Snackbar.LENGTH_LONG)
                    .setAction("Undo", this)
